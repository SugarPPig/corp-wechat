...
try { 
    ...
    $ServiceCorpAPI = new ServiceCorpAPI(
        "wwf94b13a2799d1223",
        "nAvB4MrlMYduFaGHR4XzSyfi0tEh54P4aaT-pGdpVYs",
        "vtI43G4TSVlAxe9yeidABV0baTYwhm-hxzhNQhJDqTe7VPUuABrC6j8FV3qABWHi"
    );
...
try { // 第三方服务商使用永久授权码调用企业接口 
    $authCorpId = "ww09dbbdd932d4f616";
    $permanentCode = "zRHBZ8erx35PfvqkYDFnSan_V5WbjYC6QJxG9P_rnLw";
    $authAgentId = 1000013;
