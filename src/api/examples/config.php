...
return array (
    ...
    "CORP_ID"               => "ww09dbbdd932d4f616",

    // "通讯录同步"应用的secret, 开启api接口同步后，可以在管理端->"通讯录同步"看到
//    "CONTACT_SYNC_SECRET"   => "RN0F6ABEwvcC3Nb7BMDUsfMSn8sMKNne0sOu_I-RBhY",
    "CONTACT_SYNC_SECRET"   => "HsyC7KsUSAF-RY24eS4t0W0FxVqp-fHv4YPi7-gOfPM",
