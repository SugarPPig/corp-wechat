...
use sugarfishes\corpWechat\api\datastructure\ExtattrItem;
use sugarfishes\corpWechat\api\datastructure\ExtattrList;
use sugarfishes\corpWechat\api\datastructure\User;
use sugarfishes\corpWechat\api\datastructure\Department;
use sugarfishes\corpWechat\api\datastructure\Tag;
use sugarfishes\corpWechat\api\datastructure\TagUser;
use sugarfishes\corpWechat\api\datastructure\CallBack;
use sugarfishes\corpWechat\api\datastructure\BatchJobArgs;
use sugarfishes\corpWechat\api\datastructure\BatchJobResult;
use sugarfishes\corpWechat\api\datastructure\Batch;
...
use sugarfishes\corpWechat\api\datastructure\ClickMenu;
use sugarfishes\corpWechat\api\datastructure\viewMenu;
use sugarfishes\corpWechat\api\datastructure\ScanCodePushMenu;
use sugarfishes\corpWechat\api\datastructure\ScanCodeWaitMsgMenu;
use sugarfishes\corpWechat\api\datastructure\PicPhotoOrAlbumMenu;
use sugarfishes\corpWechat\api\datastructure\PicSysPhotoMenu;
use sugarfishes\corpWechat\api\datastructure\PicWeixinMenu;
use sugarfishes\corpWechat\api\datastructure\LocationSelectMenu;
use sugarfishes\corpWechat\api\datastructure\Message;
use sugarfishes\corpWechat\api\datastructure\TextMessageContent;
use sugarfishes\corpWechat\api\datastructure\ImageMessageContent;
use sugarfishes\corpWechat\api\datastructure\VoiceMessageContent;
use sugarfishes\corpWechat\api\datastructure\VideoMessageContent;
use sugarfishes\corpWechat\api\datastructure\FileMessageContent;
use sugarfishes\corpWechat\api\datastructure\TextCardMessageContent;
use sugarfishes\corpWechat\api\datastructure\NewsArticle;
use sugarfishes\corpWechat\api\datastructure\NewsMessageContent;
use sugarfishes\corpWechat\api\datastructure\MpNewsArticle;
use sugarfishes\corpWechat\api\datastructure\MpNewsMessageContent;
use sugarfishes\corpWechat\api\datastructure\UserDetailByUserTicket;
use sugarfishes\corpWechat\api\datastructure\UserInfoByCode;
use sugarfishes\corpWechat\api\datastructure\CheckinOption;
use sugarfishes\corpWechat\api\datastructure\CheckinInfo;
use sugarfishes\corpWechat\api\datastructure\CheckinGroup;
use sugarfishes\corpWechat\api\datastructure\CheckinTime;
use sugarfishes\corpWechat\api\datastructure\CheckinDate;
use sugarfishes\corpWechat\api\datastructure\SpeWorkDays;
use sugarfishes\corpWechat\api\datastructure\SpeOffDays;
use sugarfishes\corpWechat\api\datastructure\WifiMacInfo;
use sugarfishes\corpWechat\api\datastructure\LocInfo;
use sugarfishes\corpWechat\api\datastructure\CheckinDataList;
use sugarfishes\corpWechat\api\datastructure\CheckinData;
use sugarfishes\corpWechat\api\datastructure\ApprovalDataList;
use sugarfishes\corpWechat\api\datastructure\ApprovalData;
use sugarfishes\corpWechat\api\datastructure\CommApplyEvent;
use sugarfishes\corpWechat\api\datastructure\ExpenseEvent;
use sugarfishes\corpWechat\api\datastructure\ExpenseItem;
use sugarfishes\corpWechat\api\datastructure\LeaveEvent;
use sugarfishes\corpWechat\api\datastructure\SendWorkWxRedpackReq;
use sugarfishes\corpWechat\api\datastructure\SendWorkWxRedpackRsp;
use sugarfishes\corpWechat\api\datastructure\QueryWorkWxRedpackReq;
use sugarfishes\corpWechat\api\datastructure\QueryWorkWxRedpackRsp;
use sugarfishes\corpWechat\api\datastructure\PayWwSptrans2PocketReq;
use sugarfishes\corpWechat\api\datastructure\PayWwSptrans2PocketRsp;
use sugarfishes\corpWechat\api\datastructure\InvoiceInfo;
use sugarfishes\corpWechat\api\datastructure\InvoiceUserInfo;
use sugarfishes\corpWechat\api\datastructure\BillingInfo;
use sugarfishes\corpWechat\api\datastructure\BatchUpdateInvoiceStatusReq;
use sugarfishes\corpWechat\api\datastructure\InvoiceItem;
use sugarfishes\corpWechat\api\datastructure\BatchGetInvoiceInfoReq;
use sugarfishes\corpWechat\api\datastructure\BatchGetInvoiceInfoRsp;
